 ...
 *
 * Added force of indexes to primary index to remove dependency on optimizer
 * Added FOR UPDATE where applicable
 *
 * 14 mar 2011
 */

#ifndef _NONSP_COMMON_H_
#define _NONSP_COMMON_H_
...
#if 1
#define FORCE_PRIMARY force index (primary)
#endif
...
#define DELIVERY_5 \
	"UPDATE order_line FORCE_PRIMARY\n" \
