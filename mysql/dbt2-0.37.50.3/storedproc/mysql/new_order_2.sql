...
# *
# * Changed delimiter
# * Changed from using TEXT variables to using VARCHAR's of proper size
# * Added FOR UPDATE where applicable
# * Use out_s_quantity instead of s_quantity to move calculation from UPDATE
# * statement to stored procedure to make use of PK update optimisations.
# *
# * 14 mar 2011
# *
